...
COMPONENTS_EBS_VOLUME_SIZE_LIMIT_GB = int(
    os.environ.get("COMPONENTS_EBS_VOLUME_SIZE_LIMIT_GB", "1024")
)
...
COMPONENTS_SERVICE_MAX_MEMORY_MB = int(
    os.environ.get("COMPONENTS_SERVICE_MAX_MEMORY_MB", "8192")
)
COMPONENTS_SERVICE_MEMORY_RESERVATION_MB = int(
    os.environ.get("COMPONENTS_SERVICE_MEMORY_RESERVATION_MB", "1024")
)
...
COMPONENTS_SERVICE_WAITER_INITIAL_DELAY_SECONDS = float(
    os.environ.get("COMPONENTS_SERVICE_WAITER_INITIAL_DELAY_SECONDS", "1.0")
)
...
CHALLENGE_INVOICES_DEFAULT_EXPIRE_AFTER_YEARS = int(
    os.environ.get("CHALLENGE_INVOICES_DEFAULT_EXPIRE_AFTER_YEARS", 5)
)
CHALLENGE_POSTPAID_INVOICE_ROUNDING_INCREMENT = int(
    os.environ.get("CHALLENGE_POSTPAID_INVOICE_ROUNDING_INCREMENT", 250)
)
...
CHALLENGE_REQUEST_MAX_DRAFT_REMINDERS = 2
...
WORKSTATIONS_USE_UNCLAIMED_SESSIONS = strtobool(
    os.environ.get("WORKSTATIONS_USE_UNCLAIMED_SESSIONS", "True")
)
...
WORKSTATIONS_NUMBER_UNCLAIMED_SESSIONS = int(
    os.environ.get("WORKSTATIONS_NUMBER_UNCLAIMED_SESSIONS", "5")
)
...
ALGORITHM_ENDPOINTS_EXECUTION_ROLE_ARN = os.environ.get(
    "ALGORITHM_ENDPOINTS_EXECUTION_ROLE_ARN"
)
ALGORITHM_ENDPOINTS_SNS_TOPIC_ARN = os.environ.get(
    "ALGORITHM_ENDPOINTS_SNS_TOPIC_ARN", ""
)
ALGORITHM_ENDPOINTS_SECURITY_GROUP_ID = os.environ.get(
    "ALGORITHM_ENDPOINTS_SECURITY_GROUP_ID"
)
...
ALGORITHM_ENDPOINTS_MAXIMUM_INVOCATION_DURATION = 5 * 60  # 5 minutes
ALGORITHM_ENDPOINTS_MAX_ACTIVE_ENDPOINTS_PER_USER = int(
    os.environ.get("ALGORITHM_ENDPOINTS_MAX_ACTIVE_ENDPOINTS_PER_USER", "1")
)
ALGORITHM_ENDPOINTS_MAX_ACTIVE_INVOCATIONS_PER_ENDPOINT = int(
    os.environ.get(
        "ALGORITHM_ENDPOINTS_MAX_ACTIVE_INVOCATIONS_PER_ENDPOINT", 4
    )
)
